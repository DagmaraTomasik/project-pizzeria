...

{
  ...
  class AmountWidget{
    ...
    setValue(value){
      ...
      /* TODO: Add validation */
      if(newValue != thisWidget.value && settings.amountWidget.defaultMin <= newValue && settings.amountWidget.defaultMax >= newValue){
    ...
    initData: function(){
      ...
      fetch(url)
        ...
        .then(function(parsedResponse){
          ...
          /* save parsedResponse at thisApp.data.product */
